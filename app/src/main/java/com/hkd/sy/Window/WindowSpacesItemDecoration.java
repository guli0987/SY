...
public class WindowSpacesItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public WindowSpacesItemDecoration(int bottomSpace) {
     ...
     * @param space 间距
     */
    public WindowSpacesItemDecoration(@Decoration String decoration, int space){
        switch (decoration) {
     ...
     * @param bottomSpace 下间距
     */
    public WindowSpacesItemDecoration(int rightSpace, int topSpace, int leftSpace, int bottomSpace) {
