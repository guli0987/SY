...
public class OrderSpacesItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public OrderSpacesItemDecoration(int bottomSpace) {
     ...
     * @param space 间距
     */
    public OrderSpacesItemDecoration(@Decoration String decoration, int space){
        switch (decoration) {
     ...
     * @param bottomSpace 下间距
     */
    public OrderSpacesItemDecoration(int rightSpace, int topSpace, int leftSpace, int bottomSpace) {
