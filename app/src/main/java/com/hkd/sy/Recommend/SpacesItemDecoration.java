...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public SpacesItemDecoration(int bottomSpace) {
     ...
     * @param space 间距
     */
    public SpacesItemDecoration(@Decoration String decoration, int space){
        switch (decoration) {
     ...
     * @param bottomSpace 下间距
     */
    public SpacesItemDecoration(int rightSpace, int topSpace, int leftSpace, int bottomSpace) {
